...
| 03000 - 030FF |      32b | Sprite attributes (64x32b)        |
| 03100 - 031FF |      32b | Sprite positions (64x32b)         |
| 03200 - 03FFF |        - | -                                 |
...
|    2 | TEXTPRIO | 0:Render text behind graphics, 1:Render text in fron of graphics |
|    1 | TEXT80   | 0:40 columns mode, 1:80 columns mode                             |
|    0 | TEXTEN   | Enable text                                                      |

## VSCRX register

This register controls the horizontal scrolling position in both tile and bitmap modes.
...
This register controls the vertical scrolling position in both tile and bitmap modes.
...
| ----: | ----- | ------------------------------------------------------ |
| 31:16 | -     | -                                                      |
|    15 | PRIO  | If set, render sprite above non-priority sprites/tiles |
| 14:13 | PAL   | Palette for this sprite (0-3)                          |
...
Sprites can be hidden by positioning them off-screen. The most efficient position for this is putting them vertically off-screen, this will prevent them from being rendered. Since a sprite can be 16-pixels tall, the vertical position that works for both 8 and 16 pixel tall sprites is 240.

|  Bits | Name | Description                                                        |
| ----: | :--: | ------------------------------------------------------------------ |
| 31:25 |  -   | -                                                                  |
| 24:16 |  Y   | Vertical position of sprite (0-255). Set to 240 to disable sprite. |
|  15:9 |  -   | -                                                                  |
